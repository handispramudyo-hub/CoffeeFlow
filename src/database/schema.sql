...
-- Disable RLS on all tables (dev mode — add proper policies for production)
...
ALTER TABLE IF EXISTS customer_points DISABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS customer_transactions DISABLE ROW LEVEL SECURITY;
